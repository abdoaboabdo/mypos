<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="{{Request::is(LaravelLocalization::getCurrentLocale().'/dashboard/index') ? 'active': ' '}}"><a href="{{ route('dashboard.welcome')  }}"><i class="fa fa-th"></i><span>@lang('site.dashboard')</span></a></li>
            ...
            @if (auth()->user()->hasPermission('read_users'))
                <li class="{{Request::is(LaravelLocalization::getCurrentLocale().'/dashboard/users') | Request::is(LaravelLocalization::getCurrentLocale().'/dashboard/users/create') ? 'active': ' '}}"><a href="{{ route('dashboard.users.index') }}"><i class="fa fa-th"></i><span>@lang('site.users')</span></a></li>
            @endif
            ...
            @if (auth()->user()->hasPermission('read_orders'))
                <li class="{{Request::is(LaravelLocalization::getCurrentLocale().'/dashboard/orders') | Request::is(LaravelLocalization::getCurrentLocale().'/dashboard/orders/create') ? 'active': ' '}}"><a href="{{ route('dashboard.orders.index') }}"><i class="fa fa-th"></i><span>@lang('site.orders')</span></a></li>
            @endif
